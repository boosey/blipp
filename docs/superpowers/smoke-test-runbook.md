...
| 7 | ⛔ | Blocked: iOS Capacitor playback itself is broken (intro jingle plays, then silence). Filed as issue #8. iOS staging-env wiring also incomplete — filed as issue #9. Will re-run after #8 is fixed |
