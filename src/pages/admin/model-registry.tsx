    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="border border-white/5 rounded-lg overflow-hidden">
          {/* Header row */}
          <div className="grid grid-cols-[2fr_1fr_1fr_1fr_auto] gap-4 px-4 py-2.5 bg-[#0F1D32] text-[10px] font-medium text-[#9CA3AF] uppercase tracking-wider border-b border-white/5">
            <div>Model</div>
            <div>Stage</div>
            <div>Developer</div>
            <div>Providers</div>
          ...
          {filtered.map((model) => {
            ...
            return (
              <div key={model.id}>
                {/* Model row */}
                <div
                  className="grid grid-cols-[2fr_1fr_1fr_1fr_auto] gap-4 px-4 py-3 items-center border-b border-white/5 hover:bg-white/[0.02] cursor-pointer transition-colors"
                ...
                {isExpanded && (
                  <div className="bg-[#0A1628]/50 border-b border-white/5">
                    <div className="px-8 py-2">
                      {/* Provider header */}
                      <div className="grid grid-cols-[2fr_2fr_1fr_auto] gap-4 py-2 text-[10px] font-medium text-[#9CA3AF] uppercase tracking-wider">
                        <div>Provider</div>
                        <div>Pricing</div>
                        <div>Status</div>
                      ...
                      {model.providers.map((prov) => (
                        <div key={prov.id}>
                          {editingProvider === prov.id ? (
                            ...
                            <div className="grid grid-cols-[2fr_2fr_1fr_auto] gap-4 py-2 items-center text-xs">
...
function EditProviderForm({
  ...
  return (
    <div className="grid grid-cols-[2fr_2fr_1fr_auto] gap-4 py-2 items-center">
