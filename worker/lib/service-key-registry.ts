...
export const SERVICE_KEY_CONTEXTS: ServiceKeyContext[] = [
  ...
  },
  {
    ...
    group: "Billing",
    description: "RevenueCat REST API v2 secret key (sk_...) for server-side purchase verification. Requires REVENUECAT_PROJECT_ID to also be set.",
    healthCheckable: true,
    usageTrackable: false,
  },
  {
    context: "billing.revenuecat-project",
    label: "RevenueCat Project ID",
    provider: "revenuecat",
    envKey: "REVENUECAT_PROJECT_ID",
    group: "Billing",
    description: "RevenueCat project ID (proj_...) required in v2 REST API URL paths",
    healthCheckable: false,
    usageTrackable: false,
  },
