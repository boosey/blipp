...
export function createMockEnv(): Env {
  return {
    ...
    DIGEST_ORCHESTRATOR_QUEUE: { send: vi.fn().mockResolvedValue(undefined), sendBatch: vi.fn().mockResolvedValue(undefined) } as unknown as Queue,
    DIGEST_NARRATIVE_QUEUE: { send: vi.fn().mockResolvedValue(undefined), sendBatch: vi.fn().mockResolvedValue(undefined) } as unknown as Queue,
    DIGEST_CLIP_QUEUE: { send: vi.fn().mockResolvedValue(undefined), sendBatch: vi.fn().mockResolvedValue(undefined) } as unknown as Queue,
    DIGEST_ASSEMBLY_QUEUE: { send: vi.fn().mockResolvedValue(undefined), sendBatch: vi.fn().mockResolvedValue(undefined) } as unknown as Queue,
